...
import net.minecraft.src.GuiImprovedChat;
...
public class GuiImprovedChatNewChat extends GuiNewChat
{
    ...
    {
        printChatMessage(I18n.getStringParams(message, params));
    }
     ...
     */
    @Override
	public void printChatMessageWithOptionalDeletion(String message, int id)
    {
        if (id != 0)
        {
            deleteChatLine(id);
        ...
        ImprovedChat.receiveLine(message, mc.ingameGUI.getUpdateCounter(), id);
    }
    ...
    {
        chatLines.add(line);
        sentMessages.add(line.getChatLineString());
    }
