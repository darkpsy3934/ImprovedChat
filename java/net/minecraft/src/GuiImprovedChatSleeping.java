...
public class GuiImprovedChatSleeping extends GuiSleepMP
{
	...
	public void initGui()
    {
        ...
        inputField = new GuiImprovedChatTextField(fontRenderer, 4, height - 12, width - 4, 12);
        ...
        buttonList.clear();
        buttonList.add(new GuiButton(1, width / 2 - 100, height - 40, I18n.getString("multiplayer.stopSleeping")));
    }
